...
import { DollarSign, Wallet, Clock, CheckCircle, AlertCircle, Copy } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-gradient-card shadow-card">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="text-success">Available</Badge>
            </div>
            <div className="mt-4">
              <div className="text-2xl font-bold text-foreground">$3,450.25</div>
        ...
        <Card className="bg-gradient-card shadow-card">
          <CardContent className="p-6">
            ...
            <div className="mt-4">
              <div className="text-2xl font-bold text-foreground">$12,456.80</div>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 bg-card/50 rounded-lg">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-foreground">Wallet Verified</span>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-destructive/80">
                    Payouts are processed within 24 hours. Network fees will be deducted from the payout amount.
                  </p>
                </div>
              </div>
            </div>
